...
ROLE_DEFINITIONS: List[Dict[str, str]] = [
    ...
    {"code": "FOURNISSEUR", "label": "Fournisseur", "description": "Peut vendre des produits sur la plateforme"},
...
PERMISSION_DEFINITIONS: List[Dict[str, str]] = [
    ...
    {"code": "supplier.dashboard.view", "resource": "dashboard", "action": "view", "description": "Acceder au dashboard fournisseur"},
    {"code": "supplier.products.read", "resource": "supplier.products", "action": "read", "description": "Voir ses produits"},
    {"code": "supplier.products.create", "resource": "supplier.products", "action": "create", "description": "Creer un produit"},
    {"code": "supplier.products.update", "resource": "supplier.products", "action": "update", "description": "Modifier un produit"},
    {"code": "supplier.products.delete", "resource": "supplier.products", "action": "delete", "description": "Supprimer un produit"},
    {"code": "supplier.orders.read", "resource": "supplier.orders", "action": "read", "description": "Voir les commandes de ses produits"},
    {"code": "supplier.orders.update_status", "resource": "supplier.orders", "action": "update", "description": "Modifier le statut d'une commande fournisseur"},
    {"code": "supplier.profile.read", "resource": "supplier.profile", "action": "read", "description": "Voir son profil fournisseur"},
    {"code": "supplier.profile.update", "resource": "supplier.profile", "action": "update", "description": "Modifier son profil fournisseur"},
    {"code": "supplier.stats.read", "resource": "supplier.stats", "action": "read", "description": "Voir ses statistiques de vente"},
    {"code": "supplier.request.create", "resource": "supplier.request", "action": "create", "description": "Soumettre une demande pour devenir fournisseur"},
...
ROLE_PERMISSION_MAP: List[Tuple[str, str]] = [
    ...
    ("CLIENT", "supplier.request.create"),
    ...
    ("FOURNISSEUR", "supplier.dashboard.view"),
    ("FOURNISSEUR", "supplier.products.read"),
    ("FOURNISSEUR", "supplier.products.create"),
    ("FOURNISSEUR", "supplier.products.update"),
    ("FOURNISSEUR", "supplier.products.delete"),
    ("FOURNISSEUR", "supplier.orders.read"),
    ("FOURNISSEUR", "supplier.orders.update_status"),
    ("FOURNISSEUR", "supplier.profile.read"),
    ("FOURNISSEUR", "supplier.profile.update"),
    ("FOURNISSEUR", "supplier.stats.read"),
    ("FOURNISSEUR", "supplier.request.create"),
