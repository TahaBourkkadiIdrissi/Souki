const CACHE_PREFIX = "souki-livreur-pwa"
...
self.addEventListener("notificationclick", (event) => {
  ...
  const targetHref = parsedTarget.origin === self.location.origin ? parsedTarget.href : `${self.location.origin}/livreur`
